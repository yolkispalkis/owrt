...
DEVICE_VARS += SERCOMM_0x4Cstr SERCOMM_0x5Cstr
...
define Build/sercomm-tag-factory-type-A
  ...
  $(STAGING_DIR_HOST)/bin/sercomm_tag_kernel \
    ...
    -e $@.hdrkrn2
  # Hack CRC Kernel2
  dd if=/dev/zero of=$@.hdrkrn2 bs=1 seek=$$((0x18)) count=4 conv=notrunc 2>/dev/null
...
define Device/sercomm-common-temp
  ...
  SERCOMM_0x0str := 0001
  SERCOMM_0x04str := 0000
  SERCOMM_0x10str := 0000
